...
const usage =
  "Usage: crosscheck quote|order [draft-file]  |  crosscheck accept <task-file> <deliverable-file> [reference]  |  crosscheck skillcheck <folder> [--fresh]  |  crosscheck result <job_id> <result_token>";
